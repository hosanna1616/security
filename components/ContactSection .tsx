...
const ContactSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className='relative z-10 max-w-3xl w-full px-8 py-12 bg-black/80 backdrop-blur-md rounded-xl shadow-xl border border-primary group transition-all duration-500 hover:shadow-[0_0_20px_primary]'>
        <div ref={contentRef} className='space-y-6 text-white text-center'>
          ...
          <div className='flex justify-center items-center gap-4 pt-4'>
            ...
            <button
              onClick={handleSend}
              className='px-5 py-2 bg-primary hover:bg-secondary text-black font-semibold rounded-lg transition'
            >
              Send
            </button>
          </div>
